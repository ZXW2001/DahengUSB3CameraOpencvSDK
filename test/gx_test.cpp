...
#define ACQ_BUFFER_NUM 20              ///< Acquisition Buffer Qty.
#define ACQ_TRANSFER_SIZE (128 * 1024) ///< Size of data transfer block
#define ACQ_TRANSFER_NUMBER_URB 128    ///< Qty. of data transfer block
...
int PixelFormatConvert(PGX_FRAME_BUFFER pFrameBuffer)
{
    ...
    case GX_PIXEL_FORMAT_BAYER_BG12:
    {
        ...
        emDXStatus = DxRawome8toRGB24(g_pRaw8Image, g_pRGBImageBuf, pFrameBuffer->nWidth, pFrameBuffer->nHeight,
                                   RAW2RGB_NEIGHBOUR, DX_PIXEL_COLOR_FILTER(g_i64ColorFilter), false);
        if (emDXStatus != DX_OK)
        {
            printf("DxRaw8toRGB24 Failed, Error Code: %d\n", emDXStatus);
